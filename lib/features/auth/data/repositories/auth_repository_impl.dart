...
import 'package:personal_finances_app/features/auth/domain/repositories/auth_repository.dart';
...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<User> login({required String email, required String password}) async {
    ...
    // Store tokens automatically in token storage for the interceptor
    ...
    // Store the token via the old mechanism just in case
