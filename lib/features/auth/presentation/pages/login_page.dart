  ...
  Widget build(BuildContext context) {
    ref.listen(loginControllerProvider, (previous, next) {
      if (next.hasError && !next.isLoading) {
        final errorMsg = next.error.toString().replaceFirst('Exception: ', '').replaceAll('ArgumentError: ', '');
            ...
            if (loginState.hasError && !loginState.isLoading)
              Padding(
                ...
                child: SelectableText.rich(
                  TextSpan(
                    text: 'Login failed: ${loginState.error.toString().replaceFirst('Exception: ', '').replaceAll('ArgumentError: ', '')}',
